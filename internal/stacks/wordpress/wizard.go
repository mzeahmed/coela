// Package wordpress implements the WordPress (Bedrock) stack: it asks the
// stack-specific wizard questions, exposes its template directory, and
// installs the framework via Composer. It knows nothing about any other
// stack.
package wordpress
...
// to enable, then returns a fully-populated *project.Project for a
// WordPress (Bedrock) project.
